var wheeboxtesttype = "", questionsViewedByUser = {},  questionsMarkedByUser = {}, windowLoadStatus = "freshWindow";
...
if(compCode == "0176002"){
	document.getElementById('b').innerHTML =
		...
		'src = https://achievementtest.pearsonmypedia.com//WET-2/assest/images/internet.png?'+Math.random() + '" ' +
            ...
            function GUID ()
{
    ...
    return (
            ...
            {   
                ...
                var guid = GUID();
              // var url="http://www.wheebox.com/WET/qq.jsp?id="+guid;
             // var url="http://119.81.48.75/WET/qq.jsp?id="+guid; 
            //var url="http://www.mywheebox.com:8080/WET/qq.jsp?id="+guid;
					...
					mainchekingforcheeet1=false;
	      	        ...
	      	        if(document.getElementById("beforeTestLoad")){
		      	     document.getElementById("beforeTestLoad").style.display="none";
	      	      	    ...
	      	      	    if($("#gracePeriod").val() == "true") {
	      	      	    	testExpiredCountDown();
      	      	    	}
	      	      	    	}
	              	  	var value=document.getElementById('hid').value;
                          ...
                          if(document.getElementById("comp_code").value === "0311000"){
                      		...
                      		if((flagStatusValue !== "next" && flagStatusValue !== "previous") && (j=="mark" || j=="unmark" || j=="flag" || j=="unflag" || j=="autoglide")) {
	                  			  ...
	                  			  if(found === undefined || found === null || found === "") {
	                  				  document.getElementById("butt"+value).style.background="grey";
	                  			  }else {
	                  				  document.getElementById("butt"+value).style.background="#9ACD32";
	                  			  }
                  			...
                  			if(j === "previous" && parseInt(value) > 1) {
                      			...
                      			flagStatusValue = document.getElementById("flag"+newValue).value;
		  	                  		...
		  	                  		if(flagStatusValue === "mark") {
	  	                  			  ...
	  	                  			  console.log("UserAns: ["+found+"]");
	  	                  			  if(found === undefined || found === null || found === "") {
	  	                  				  document.getElementById("butt"+newValue).style.background="grey";
	  	                  			  }else {
	  	                  				  document.getElementById("butt"+newValue).style.background="#9ACD32";
	  	                  			  }
		  		                        document.getElementById("markx").style.display="block";
		  		                        document.getElementById("unmarkv").style.display="none";
		  		                  		  document.getElementById("x").style.display="block";
      						...
      						{ 
                              	...
                              	if((valueOTH== document.getElementById('size').value && vv=='next')|| (valueOTH== document.getElementById('size').value && vv=="autoglide" && booleanforautoglide)  ){
                              		...
                              		if(value== document.getElementById('size').value && vv=="autoglide" && booleanforautoglide){
                                           ...
                                           else document.getElementById("butt"+value).style.background="#9ACD32";
                              		}
                              		if((sectiondetail[document.getElementById("section"+value).value].pat != 'ADP') && (sectiondetail[document.getElementById("section"+value).value].pat != 'PSY')){
                               ...
                               return false;
         							...
         							//alert(actans);
                                      ...
                                      document.getElementById('hid_marks'+value).value= arr15[value];
                                         ...
                                         //alert(flagvalue);
                                         if(flagvalue=="flag") document.getElementById("butt"+value).style.background="#DC143C";
                                         else if(us_ans !='')document.getElementById("butt"+value).style.background="#9ACD32";     
         							}
                              ...
                              for(var j=0;j<a1.length;j++)
                                  {   if(a1[j].checked==true)
                                      {    document.getElementById("user_ans"+value).value=a1[j].value;
                                          ...
                                          var flagvalue=document.getElementById("flag"+value).value;
                                          if(flagvalue=="flag") document.getElementById("butt"+value).style.background="#DC143C";
                                          else document.getElementById("butt"+valueOTH).style.background="#9ACD32";                                     
                                              }
                                      xxx=10;  
                                      }
                                  else{
...
//                                  		alert(storingQflag);
						 ...
						 if(xxx==-4 && qtype[value]=="3"){
                                        		  ...
                                        		  document.getElementById("butt"+value).style.background="#7C7C7C";
          						...
          						{	
          							...
          							if(qtype[value]!=questionflagforwest){
      	    							...
      	    							if(user_ans.toUpperCase()== act_ans.toUpperCase())
      	                                {
      	    								...
      	    								document.getElementById("butt"+(valueADP)).style.background="#9ACD32";
										...
										if(document.deviceApplet.area.getText()!=document.deviceApplet.snipitstring){
                    						...
                    						//	alert(questionidfromQUESID);
                                        	  ...
                                        	  if(prev_response!=""){ 
                                        		  ...
                                        		  str=str+"<tr><td ><font color=#404040><b><p align='justify' id='typingQuestionText"+value+"' >"+arr1[value]+"</p><input type='hidden' id='typingQuestionTextValue"+value+"' name='typingQuestionTextValue"+value+"' value='"+arr1[value]+"' > </b></font>";
          ...
          //------------------------------------------------ Hitesh Work --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------                        
                                        ...
                                        { //document.getElementById("drag").style.display='none';
                                        	...
                                        	if(comp_code =='0215000' || comp_code =='0262000'){ 
		                                        for (var b=0; b<opt;b++)   
		                                        {		if(b==0 && arr1[value]!='') {str11=str11+"<input type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"a' name='option"+value+"' onblur='buttColor(this.id);' onkeyup='checknumerical(this.id)' /><font style='color: #4c949c'> "+" "+(arr1[value])+"</font> "+" ";option_random.push(str11.replace(/^\s+|\s+$/g, ''));}
		                                                if(b==1 && arr2[value]!='') {str22=str22+"  <input  type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"b' name='option"+value+"' onclick='buttColor(this.id);' onkeyup='checknumerical(this.id)' > <font style='color: #4c949c'>"+" "+(arr2[value])+"</font> "+" ";option_random.push(str22.replace(/^\s+|\s+$/g, ''));}
		                                                if(b==2 && arr3[value]!='') {str3=str3+" <input  type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"c' name='option"+value+"' onclick='buttColor(this.id);' onkeyup='checknumerical(this.id)' > <font style='color: #4c949c'>"+" "+(arr3[value])+"</font> "+" ";option_random.push(str3.replace(/^\s+|\s+$/g, ''));}
		                                                if(b==3 && arr4[value]!='') {str4=str4+" <input type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"d' name='option"+value+"' onclick='buttColor(this.id);' onkeyup='checknumerical(this.id)' > <font style='color: #4c949c'>"+" "+(arr4[value])+"</font> "+" ";option_random.push(str4.replace(/^\s+|\s+$/g, ''));}
		                                                if(b==4 && arr5[value]!='') {str5=str5+" <input type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"e' name='option"+value+" onclick='buttColor(this.id);' onkeyup='checknumerical(this.id)' > <font style='color: #4c949c'>"+" "+(arr5[value])+"</font> "+" ";option_random.push(str5.replace(/^\s+|\s+$/g, ''));}
		                                                if(b==5 && arr6[value]!='') {str6=str6+" <input type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"f' name='option"+value+"'  onclick='buttColor(this.id);' onkeyup='checknumerical(this.id)' > <font style='color: #4c949c'>"+" "+(arr6[value])+"</font> "+" ";option_random.push(str6.replace(/^\s+|\s+$/g, ''));}
		                                         }
                                        	}else if(comp_code =='0290000' || comp_code =='0382000'){ 
                                                for (var b=0; b<opt;b++)   
                                                {		if(b==0 && arr1[value]!='') {str11=str11+"<input type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"a' name='option"+value+"' onkeyup='checkNumericInput(this.id)' onblur='buttColor(this.id);' /><font style='color: #4c949c'> "+" "+(arr1[value])+"</font> "+" ";option_random.push(str11.replace(/^\s+|\s+$/g, ''));}
                                                        if(b==1 && arr2[value]!='') {str22=str22+"  <input  type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"b' name='option"+value+"' onkeyup='checkNumericInput(this.id)' onblur='buttColor(this.id);' > <font style='color: #4c949c'>"+" "+(arr2[value])+"</font> "+" ";option_random.push(str22.replace(/^\s+|\s+$/g, ''));}
                                                        if(b==2 && arr3[value]!='') {str3=str3+" <input  type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"c' name='option"+value+"' onkeyup='checkNumericInput(this.id)' onblur='buttColor(this.id);' > <font style='color: #4c949c'>"+" "+(arr3[value])+"</font> "+" ";option_random.push(str3.replace(/^\s+|\s+$/g, ''));}
                                                        if(b==3 && arr4[value]!='') {str4=str4+" <input type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"d' name='option"+value+"' onkeyup='checkNumericInput(this.id)' onblur='buttColor(this.id);' > <font style='color: #4c949c'>"+" "+(arr4[value])+"</font> "+" ";option_random.push(str4.replace(/^\s+|\s+$/g, ''));}
                                                        if(b==4 && arr5[value]!='') {str5=str5+" <input type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"e' name='option"+value+" onkeyup='checkNumericInput(this.id)' onblur='buttColor(this.id);' > <font style='color: #4c949c'>"+" "+(arr5[value])+"</font> "+" ";option_random.push(str5.replace(/^\s+|\s+$/g, ''));}
                                                        if(b==5 && arr6[value]!='') {str6=str6+" <input type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"f' name='option"+value+"' onkeyup='checkNumericInput(this.id)' onblur='buttColor(this.id);' > <font style='color: #4c949c'>"+" "+(arr6[value])+"</font> "+" ";option_random.push(str6.replace(/^\s+|\s+$/g, ''));}
                                                 }
                                            } else
                                        		{ 
                                        		 for (var b=0; b<opt;b++)   
                                                 {		if(b==0 && arr1[value]!='') {str11=str11+"<input type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"a' name='option"+value+"' onblur='buttColor(this.id);' /><font style='color: #4c949c'> "+" "+(arr1[value])+"</font> "+" ";option_random.push(str11.replace(/^\s+|\s+$/g, ''));}
                                                         if(b==1 && arr2[value]!='') {str22=str22+"  <input  type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"b' name='option"+value+"' onclick='buttColor(this.id);' > <font style='color: #4c949c'>"+" "+(arr2[value])+"</font> "+" ";option_random.push(str22.replace(/^\s+|\s+$/g, ''));}
                                                         if(b==2 && arr3[value]!='') {str3=str3+" <input  type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"c' name='option"+value+"' onclick='buttColor(this.id);' > <font style='color: #4c949c'>"+" "+(arr3[value])+"</font> "+" ";option_random.push(str3.replace(/^\s+|\s+$/g, ''));}
                                                         if(b==3 && arr4[value]!='') {str4=str4+" <input type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"d' name='option"+value+"' onclick='buttColor(this.id);' > <font style='color: #4c949c'>"+" "+(arr4[value])+"</font> "+" ";option_random.push(str4.replace(/^\s+|\s+$/g, ''));}
                                                         if(b==4 && arr5[value]!='') {str5=str5+" <input type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"e' name='option"+value+"' onclick='buttColor(this.id);' > <font style='color: #4c949c'>"+" "+(arr5[value])+"</font> "+" ";option_random.push(str5.replace(/^\s+|\s+$/g, ''));}
                                                         if(b==5 && arr6[value]!='') {str6=str6+" <input type='text' style='border:0px;border-bottom-width:1px;border-bottom-style:dashed;width:300px;padding-left:10px;' id='"+value+"f' name='option"+value+"'  onclick='buttColor(this.id);' > <font style='color: #4c949c'>"+" "+(arr6[value])+"</font> "+" ";option_random.push(str6.replace(/^\s+|\s+$/g, ''));}
                                                  }
                                        		}
                                        }
                                        else if(qtype[value]=="21") 
                                        ...
                                        { //document.getElementById("drag").style.display='none'; 
                                         ...
                                         if((qtype[value]=="1"||qtype[value]=="3"||qtype[value]=="16"||qtype[value]=="10"||qtype[value]=="11"||qtype[value]=="35") && (clearResp=='ON' || clearResp=='on')){
                                        	 ClearResponse="<a href='#' onclick='clrearResponse();' class='btn btn-block btn-default btn-xs' style='text-decoration: none;width:200px;' >"+jsonObj[17003]+" </a>";
                                         }      
            ...
            function configureprogrammingquestion(programmingAns,qid){
            	...
            	if(programmingAns!=""){
            		 ...
            		 var flagvalue=document.getElementById("flag"+currentQuestion).value;
                       if(flagvalue=="flag") document.getElementById("butt"+currentQuestion).style.background="#DC143C";
                       else document.getElementById("butt"+currentQuestion).style.background="#9ACD32"; 
            	}
           	...
           	document.getElementById(currentQuestion).value = programmingAns ;	
                	...
                	if(programmingAns!=""){
                		 ...
                		 var flagvalue=document.getElementById("flag"+valueOTH).value;
                           if(flagvalue=="flag") document.getElementById("butt"+valueOTH).style.background="#DC143C";
                           else document.getElementById("butt"+valueOTH).style.background="#9ACD32"; 
                	}
                        ...
                        if(userSqlQueryResp!=""){
                        	 insertinSqlResp(userSqlQueryResp,currentQuesIndex);
                     		 var flagvalue=document.getElementById("flag"+currentQuesIndex).value;
                                if(flagvalue=="flag") document.getElementById("butt"+currentQuesIndex).style.background="#DC143C";
                                else document.getElementById("butt"+currentQuesIndex).style.background="#9ACD32"; 
                     	}
                        document.getElementById("user_ans"+currentQuesIndex).value = userSqlQueryResp ;
...
//	                            $("#documentTypeFileDownload").attr("href", fileurl);
	                            document.getElementById("butt"+document.getElementById('hid').value).style.background="#9ACD32";
...
function checkNumericInput(inputElementID) {
	var x = document.getElementById(inputElementID).value;
	if(!(isNaN(x))) {
		if(x.includes(".")) {
			var str=x.split(".")[1];
			if(str.length > 2){
...
function countCharcterOfText(textId,paragraphId,evt){
	...
	var paraValue = document.getElementById(paragraphId).value;
...
function testExpiredCountDown() {
	var totalAllowedSecondTemp = $("#totalAllowedSecond").val();
	totalAllowedSecond = parseInt(totalAllowedSecondTemp);
	testExpired=setInterval(function(){StartTestExpiredCount();},1000);
}
function StartTestExpiredCount(){
	if(totalAllowedSecond > 0){
		totalAllowedSecond--;
	}
	//console.log(totalAllowedSecond+"==totalAllowedSecond");
	if(totalAllowedSecond <= 0){
		testImage();
	}
}
...
function callSubjectiveCheeting() {
	var navigateStatus=parent.document.getElementById("navig").value;
